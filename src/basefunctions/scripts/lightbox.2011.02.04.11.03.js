...
lightbox.setNextImage = function (image) {
	...
	var img = document.createElement("IMG"), right, size = this.getPageSize();
	img.setAttribute("id", "lightboxNextImage");
	img.setAttribute("src", image);
	right = parseInt(((size[2])/2)-63);
...
lightbox.displayItem = function(arrayElem) {
	...
	document.getElementById("lightboxRelativeWrapper").removeChild(document.getElementById("lightboxNextImage"));
	document.getElementById("lightboxRelativeWrapper").removeChild(document.getElementById("lightboxPreviousImage"));
	this.setNextImage();
	this.setPreviousImage();
	document.getElementById("lightboxRelativeWrapper").appendChild(this.getNextImage());
	document.getElementById("lightboxRelativeWrapper").appendChild(this.getPreviousImage());
...
lightbox.handleScroll = function(e) {
	...
	if (document.getElementById("lightBoxWrapper")) {
		document.getElementById("lightBoxWrapper").style.top = scroll[1]+"px";
	}
};
/** lightbox.hide()
...
window.onkeypress = lightbox.bindKeyPress;
