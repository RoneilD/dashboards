	...
	// Display Functions {
		...
		*/
		function displayUserProfile($profile)
		{
		        ...
		        echo("</div>".PHP_EOL);
		        ## More|Less
		        echo("<div class=\"userProfileMoreLess\" id=\"profile_".$profile["id"]."\" onclick=\"profiles.show(this);\">more</div>".PHP_EOL);
		        ## Collapsible div
		        echo("<div class=\"userProfileMoreInformation\" id=\"profileData[".$profile["id"]."]\" style=\"display:none;\">".PHP_EOL);
		        echo("<div>".PHP_EOL);
		        echo("<label style=\"font-weight:bold;margin-bottom:2px;width:75px;\">Birthday:</label><label style=\"margin-bottom:2px;width:205px;\">".$profile["birthday"]."</label><br class=\"clear\" />".PHP_EOL);
