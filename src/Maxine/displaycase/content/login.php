...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <head>
        ...
        <script src="<?php echo BASE;?>/basefunctions/scripts/dark/js/vendor/modernizr-2.6.2.min.js"></script>
        ...
        <script src="<?php echo BASE;?>Maxine/displaycase/content/sitejs/vendor/jquery.flot/jquery.flot.js"></script>
          ...
          <div id="login">
            ...
            <div class="formWrapper">
              ...
              <div class="inner">
                ...
                <form action="/Maxine/?login" method="post">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <input type="password" value="" placeholder="Password" name="pass_word" AUTOCOMPLETE='OFF' /> 
                    ...
                    <li>
                      ...
                      <input type="submit" class="btn button submit" value="Login"/>
