<?php
/** CLASS::Scaffold_Forms_SearchNewspaper_articles
...
class Scaffold_Forms_SearchNewspaper_articles
{
  ...
  public function setHtml($html = null)
  {
          ...
          if ($html === null) {
                  ...
                  $html .= "<label for=\"date_published\">Date Published</label>";
                  $html .= "<input id=\"date_published\" name=\"date_published\" onblur=\"this.value = this.value.replace(/\//g, '-');\" readonly=\"readonly\" type=\"text\" value=\"".($_POST ? $_POST["date_published"] : "")."\" />&nbsp;";
                  $html .= "<img alt=\"calendar\" onclick=\"displayDatePicker('date_published', this, 'ymd', '');\" src=\"".BASE."images/calendar.png\" style=\"cursor:pointer;height:16px;width:14px;\" />";
                  $html .= "<br />".PHP_EOL;
                  // $html .= "<label for=\"image\">Image</label>";
                  // $html .= "<input id=\"image\" name=\"image\" type=\"text\" value=\"".($_POST ? $_POST["image"] : "")."\" /><br />".PHP_EOL;
                  $html .= "<label for=\"periodical\">Periodical</label>";
                  $html .= "<input id=\"periodical\" name=\"periodical\" type=\"text\" value=\"".($_POST ? $_POST["periodical"] : "")."\" /><br />".PHP_EOL;
  ...
  //: Magic
  /** Scaffold_Forms_SearchNewspaper_articles::__construct()
    * Class constructor
  */
  ...
  /** Scaffold_Forms_SearchNewspaper_articles::__destruct()
    * Class destructor
