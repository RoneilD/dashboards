...
define('NICUPLOAD_PATH', $base.'/images'); // Set the path (relative or absolute) to
                                      // the directory to save image files
                                      
define('NICUPLOAD_URI', 'http;//'.$_SERVER["SERVER_NAME"].'/images');   // Set the URL (relative or absolute) to
