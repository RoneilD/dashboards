<?PHP
	...
	print("<embed src='".BASE."/images/Heading_Fleet.swf'
		FlashVars='fleet_name=".$fleetlist[$count]["name"]."&budget=".(number_format($totbudget))."&income=".(number_format($totincome))."&variance=".number_format($variance)."'
		quality='high'
		width='".(750 * $factor)."px'
	...
	print("<embed src='".BASE."/images/Graph2.swf'
